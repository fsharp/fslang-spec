...
of an environment is found in [§14.1](inference-procedures.md#141-name-resolution).
...
environment `env` (see [§14.1.3](inference-procedures.md#1413-opening-modules-and-namespace-declaration-groups)).
...
A value definition that has explicit type variables is called a type function ([§10.2.3](namespaces-and-modules.md#1023-type-function-definitions-in-modules)).
...
definitions in expressions ([§14.6](inference-procedures.md#146-checking-and-elaborating-function-value-and-member-definitions)), with the following adjustments:

- Each defined value may have an accessibility annotation ([§10.5](namespaces-and-modules.md#105-accessibility-annotations)). By default, the accessibility
...
- Each defined value can be used to satisfy the requirements of any signature for the module
    ([§11.2](namespace-and-module-signatures.md#112-signature-conformance)).
- Each defined value is subject to arity analysis ([§14.10](inference-procedures.md#1410-arity-inference)).
...
Type functions receive special treatment during generalization ([§14.6.7](inference-procedures.md#1467-generalization)) and signature conformance
([§11.2](namespace-and-module-signatures.md#112-signature-conformance)). They typically have either the `RequiresExplicitTypeArguments` attribute or the
...
([§14.1.2](inference-procedures.md#1412-name-resolution-in-module-and-namespace-paths)). For example, `System.Collections.Generic` may resolve to one or more namespace
...
specified in [§14.1.3](inference-procedures.md#1413-opening-modules-and-namespace-declaration-groups). An error occurs if any `Fi` is a module that has the `RequireQualifiedAccess`
attribute.
...
Resolution in Module and Namespace Paths_ (see [§14.1](inference-procedures.md#141-name-resolution)). The list is then appended to the set of
