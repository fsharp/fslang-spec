...
lexical analysis of the input text according to the lexical rules in [§15.1.3](lexical-filtering.md#1513-grammar-rules-including-inserted-tokens). Pre-parsing for lightweight
...
The entry `f x` in the precedence table in [§4.4.2](basic-grammar-elements.md#442-precedence-of-symbolic-operators-and-patternexpression-constructs) refers to a function application in which the function
...
The entry `f<types> x` in the precedence table ([§4.4.2](basic-grammar-elements.md#442-precedence-of-symbolic-operators-and-patternexpression-constructs)) refers to any identifier that is followed
