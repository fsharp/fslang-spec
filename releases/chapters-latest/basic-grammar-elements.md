...
formats for the different constants are defined in [§3.](lexical-analysis.md#3-lexical-analysis)
...
| --- | --- | --- |
| f<types> | Left | High-precedence type application; see [§15.3](lexical-filtering.md#153-lexical-analysis-of-type-applications)
| f(x) | Left | High-precedence application; see [§15.2](lexical-filtering.md#152-high-precedence-application)
| . | Left |
...
are the result of the augmentation of the lexical token stream, as described in §15.2 and [§15.3](lexical-filtering.md#153-lexical-analysis-of-type-applications).
