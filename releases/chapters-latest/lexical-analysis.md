...
The following token forms are reserved, except when they are part of a symbolic keyword ([§3.6](lexical-analysis.md#36-symbolic-keywords)).
...
except where the sequence of characters is a symbolic keyword ([§3.6](lexical-analysis.md#36-symbolic-keywords)).
...
The `quote-op-left` and `quote-op-right` operators are used in quoted expressions ([§6.8](expressions.md#68-quoted-expressions)).
